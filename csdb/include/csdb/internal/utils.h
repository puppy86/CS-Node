...
//Adds a final delimiter in the path
std::string path_add_separator(const std::string &path);

//Path to the folder for storing app data
...
//The function creates the full path to the specified directory
bool path_make(const std::string &path);

//The function deletes the directory at the specified path
